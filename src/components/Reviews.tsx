      ...
      <div className="reviews__inner">
        ...
        <ul className="reviews__track" ref={ref}>
          {(testimonials ?? []).map((review) => {
            const starCount = Math.min(5, Math.max(1, Math.round(review.rating || 5)))
            return (
              <li className="reviews__card" key={review.id}>
                <div className="reviews__card-head">
                  ...
                  <div className="reviews__stars" aria-label={`Rated ${starCount} out of 5`}>
                ...
                <footer className="reviews__person">
                  <img
                    ...
                    src={review.avatar?.url ? mediaUrl(review.avatar.url) : avatarFallback}
                    alt=""
                    loading="lazy"
                  />
